...
angular.module('johayo.controller')
    .controller('bookmarkController', ['$scope', 'bookmarkService', 'bookmarkList', 'boardService', 'fileService',
        function($scope, bookmarkService, bookmarkList, boardService, fileService){
            ...
            $scope.getUrlImg = function(url){
                ...
                if(!validateURL(url.replace('http://', '').replace('https://', ''))){
                    return;
                }
